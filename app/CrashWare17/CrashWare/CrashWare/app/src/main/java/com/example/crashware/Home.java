...
public class Home extends AppCompatActivity {
    ...
    public void irParaTelaExtra(Fragment novoFragmento) {
        getSupportFragmentManager().beginTransaction()
                .hide(active) // Esconde a tela atual
                .add(R.id.fragment_container, novoFragmento) // Adiciona a nova tela por cima
                .addToBackStack(null) // Opcional: permite usar o botão voltar do celular
                .commit();
